...
class Unit : public WorldObject
{
    ...
    private:
        ...
        bool HandleDummyAuraProc(Unit* victim, uint32 damage, AuraEffect* triggeredByAura, SpellInfo const* procSpell, uint32 procFlag, uint32 procEx, WeaponAttackType attType, uint32 cooldown);
