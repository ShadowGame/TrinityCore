    ...
    struct boss_omnotronAI : public ScriptedAI
    {
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            if(!intialized)
            {
				...
				MaxHealth =  trons[0]->GetMaxHealth();
...
public:
    ...
    struct boss_tronsAI : public ScriptedAI
    {
        ...
        {
			Creature* omnotron = ObjectAccessor::GetCreature(*me,instance->GetData64(BOSS_OMNOTRON));
        ...
        void DoAction(const int32 action)
        {
            ...
            case ACTION_TRON_ACTIVATE:
                ...
                {
                    case NPC_MAGMATRON:
                        if ( (me->GetPower(POWER_MANA)/**100 / me->GetMaxPower(POWER_MANA)*/ < 51))	//divide by zero ...hmm
                        {
