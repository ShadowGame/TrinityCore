        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_MASSACRE:
					...
					instance->DoSendNotifyToInstance("INSTANCE MESSAGE: Chimaeron's Massacre"); // Massacre Notification
...
public:
    ...
    bool OnGossipHello(Player* pPlayer, Creature* creature)
    {
        ...
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Help us with Bille-O-Tron 800!", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
    ...
    struct mob_bile_o_tronAI : public ScriptedAI
    {
        ...
        void DoAction(const int32 action)
        {
            ...
            case ACTION_BILE_O_TRON_SYSTEM_FAILURE:
                ...
                if(Creature* finkle_einhorn = ObjectAccessor::GetCreature(*me,instance->GetData64(NPC_FINKLE_EINHORN)))
                    finkle_einhorn->MonsterYell("A helping Hand?",0,0);
